package com.kelvin.openapi.common.exception;
...
public class Assert {
    ...
    public static void isTrue(boolean expression, String errorMsgTemplate, Object... params) throws ServiceException {
        isTrue(expression, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
     ...
     *      return new ServiceException(400, "relation message to return");
     *  });
     * </pre>
     *
     * @param <X>           异常类型
    ...
    public static void isFalse(boolean expression, String errorMsgTemplate, Object... params) throws ServiceException {
        isFalse(expression, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static void isNull(Object object, String errorMsgTemplate, Object... params) throws ServiceException {
        isNull(object, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <T> T notNull(T object, String errorMsgTemplate, Object... params) throws ServiceException {
        return notNull(object, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
     ...
     * @see StrUtil#isNotEmpty(CharSequence)
     */
    public static <T extends CharSequence> T notEmpty(T text, String errorMsgTemplate, Object... params) throws ServiceException {
        return notEmpty(text, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
     ...
     * @see StrUtil#isNotBlank(CharSequence)
     */
    public static <T extends CharSequence> T notBlank(T text, String errorMsgTemplate, Object... params) throws ServiceException {
        return notBlank(text, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static String notContain(String textToSearch, String substring, String errorMsgTemplate, Object... params) throws ServiceException {
        return notContain(textToSearch, substring, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
     ...
     */
    public static <T> T[] notEmpty(T[] array, String errorMsgTemplate, Object... params) throws ServiceException {
        return notEmpty(array, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <T> T[] noNullElements(T[] array, String errorMsgTemplate, Object... params) throws ServiceException {
        return noNullElements(array, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
     ...
     */
    public static <E, T extends Iterable<E>> T notEmpty(T collection, String errorMsgTemplate, Object... params) throws ServiceException {
        return notEmpty(collection, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
     ...
     */
    public static <K, V, T extends Map<K, V>> T notEmpty(T map, String errorMsgTemplate, Object... params) throws ServiceException {
        return notEmpty(map, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <T> T isInstanceOf(Class<?> type, T obj, String errorMsgTemplate, Object... params) throws ServiceException {
        ...
        if (false == type.isInstance(obj)) {
            throw new ServiceException(400, StrUtil.format(errorMsgTemplate, params));
        }
        return obj;
    }
    ...
    public static int checkBetween(int value, int min, int max, String errorMsgTemplate, Object... params) {
        return checkBetween(value, min, max, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static Number checkBetween(Number value, Number min, Number max) {
        ...
        if (valueDouble < minDouble || valueDouble > maxDouble) {
            throw new ServiceException(400, StrUtil.format(TEMPLATE_VALUE_MUST_BE_BETWEEN_AND, min, max));
        }
        return value;
    }
     ...
     * @throws ServiceException obj1 must be not equals obj2
     */
    public static void notEquals(Object obj1, Object obj2, String errorMsgTemplate, Object... params) throws ServiceException {
        notEquals(obj1, obj2, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
     ...
     * @throws ServiceException obj1 must be equals obj2
     */
    public static void equals(Object obj1, Object obj2, String errorMsgTemplate, Object... params) throws ServiceException {
        equals(obj1, obj2, () -> new ServiceException(400, StrUtil.format(errorMsgTemplate, params)));
    }
    ...
    private static String badIndexMsg(int index, int size, String desc, Object... params) {
        if (index < 0) {
            ...
            throw new ServiceException(400, "negative size: " + size);
        } else { // index >= size
